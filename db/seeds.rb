...
#creating users 
user1 = User.create!(username: 'veronika.pilipenko', password: 'hello123456')
user2 = User.create!(username: 'mara.finkel', password: 'passwordpassword')
user3 = User.create!(username: 'christopher', password: 'hellofriends')
user4 = User.create!(username: 'mike.madsen', password: 'thisismypassword')
user5 = User.create!(username: 'elon.musk', password: '123456')
user6 = User.create!(username: 'will.sanders', password: 'idontknowmyname')
user7 = User.create!(username: 'mikem', password: 'teslaspacerocket')

#adding pictures to the database 


file1 = open("https://inaflash-seeds.s3.amazonaws.com/ocean.jpg")
...
picture1 = Picture.new(title: 'ocean', private: false, description: 'lovely view of the ocean', user_id: user1.id)
...
picture1.picture.attach(io: file1, filename: 'ocean.jpg')
