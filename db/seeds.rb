...
file3 = open("https://inaflash-seeds.s3.amazonaws.com/green+woods.jpeg")
file4 = open("https://inaflash-seeds.s3.amazonaws.com/giraffee.jpeg")
file5 = open("https://inaflash-seeds.s3.amazonaws.com/lakehouse.jpeg")
file6 = open("https://inaflash-seeds.s3.amazonaws.com/yellow.jpeg")
file7 = open("https://inaflash-seeds.s3.amazonaws.com/lavender.jpeg")
file8 = open("https://inaflash-seeds.s3.amazonaws.com/surt.jpeg")
file9 = open("https://inaflash-seeds.s3.amazonaws.com/snow.jpeg")
file10 = open("https://inaflash-seeds.s3.amazonaws.com/mountainnnn.jpeg")
...
picture3 = Picture.new(title: 'Green Woods', private: true, description: 'The trees will change color during the fall', user_id: user8.id)
picture4 = Picture.new(title: 'Giraffee', private: true, description: 'A girrafe stands with a light sky behind him', user_id: user6.id)
picture5 = Picture.new(title: 'House on a lake', private: false, description: 'A small house stands at the tip of a lake', user_id: user10.id)
picture6 = Picture.new(title: 'Yellow Background', private: false, description: 'A lovely woman poses beside a bright yellow background', user_id: user4.id)
...
picture8 = Picture.new(title: 'Surfing Session', private: false, description: 'A wonderful time while surfing the beach in California', user_id: user3.id)
picture9 = Picture.new(title: 'Snow', private: true, description: 'First snowfall emerges from the sky', user_id: user9.id)
picture10 = Picture.new(title: 'Snowy Mountains', private: true, description: 'Stunning photo of the beautiful, snowy mountains, in the middle of winter', user_id: user5.id)
...
picture3.picture.attach(io: file8, filename: 'green+woods.jpeg')
picture4.picture.attach(io: file6, filename: 'giraffee.jpeg')
picture5.picture.attach(io: file10, filename: 'lakehouse.jpeg')
picture6.picture.attach(io: file4, filename: 'yellow.jpeg')
picture7.picture.attach(io: file7, filename: 'lavender.jpeg')
picture8.picture.attach(io: file3, filename: 'surt.jpeg')
picture9.picture.attach(io: file9, filename: 'snow.jpeg')
picture10.picture.attach(io: file5, filename: 'mountainnnn.jpeg')
